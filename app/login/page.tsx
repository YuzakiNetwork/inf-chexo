...
export default function Login() {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      const { data, error: authError } = await withTimeout(client.auth.signInWithPassword({ email: email.trim(), password }));
      ...
      // Full navigation guarantees the browser sends the fresh Supabase session
      // through middleware before rendering the protected portal.
